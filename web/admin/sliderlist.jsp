                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        <label class="control-label">Status:  </label> ${s.isActive()?'<span class="label label-success" style="font-size: 15px">Active</span>':'<span class="label label-danger" style="font-size: 15px">Inactive</span>'}
                                                                    </div>
                                                                    <div class="form-group col-md-12">
